...
describe('<MediaMatch/>', () => {
  ...
  it('should show or hide based on the media passed', () => {
    ...
    expect(mobileTopHeading.parentElement).toHaveStyleRule('display', 'block', {
